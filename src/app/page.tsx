      ...
      >
        {filteredPlugins.map((plugin) => {
          ...
          const selectedVersion =
            selectedVersions[plugin.name] || (releases[0]?.tag_name ?? "");
            ...
            >
              <div className="p-6">
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  {Object.entries(plugin.dependencies || {}).map(
                    ([name, version]) => (
                      <span
                        key={name}
                  ...
                  {releases.length > 0 ? (
                    <div className="flex gap-2">
                      <select
                        ...
                        onChange={(e) =>
                          handleVersionChange(plugin, e.target.value)
                        }
                      >
                ...
                <div className="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                  ...
                  <div className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400 mt-1">
                    ...
                    <span>
                      總下載次數:{" "}
                      {plugin.repository?.releases?.total_downloads || 0}
                    </span>
                  </div>
                </div>
              </div>
